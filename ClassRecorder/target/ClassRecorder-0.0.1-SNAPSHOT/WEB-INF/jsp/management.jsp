<html>
	...
	<!-- DIV CON EL LOADER -->
	<div class="modal fade" id="myModal" style="left:50%;position: absolute; top: 50%; margin-left:-150px; margin-top:-150px">
	...
	<script type="text/javascript">
		...
		function GetFile(dataFileName){
		    ...
		    stompClient.connect({}, function(frame) {
				...
				stompClient.send("/crws/msg", {},JSON.stringify({action: 'DOWNLOAD', actionInfo: dataFileName}));
		...
		function DoAll(fileName){
		    ...
		    stompClient.connect({}, function(frame) {
				...
				stompClient.send("/crws/msg", {},JSON.stringify({action: 'DOWNLOAD', actionInfo: fileName}));
				$('#myModal').modal({backdrop: 'static', keyboard: false})
		...
		function DeleteFile(fileName){
		    ...
		    stompClient.connect({}, function(frame) {
				...
				stompClient.send("/crws/msg", {},JSON.stringify({action: 'DELETE', actionInfo: fileName}));
